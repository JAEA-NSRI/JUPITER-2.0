...
yy34:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_int); }
yy35:
      yych = *++cur;
      if (yych == '6') goto yy50;
      goto yy11;
...
yy48:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_char); }
yy49:
      yych = *++cur;
      if (yych == 'E') goto yy68;
      if (yych == 'e') goto yy68;
...
yy53:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_i8); }
yy54:
      yych = *++cur;
      if (yych == 'X') goto yy72;
      if (yych == 'x') goto yy72;
...
yy55:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_long); }
yy56:
      yych = *++cur;
      if (yych == 'F') goto yy73;
      if (yych == 'f') goto yy73;
...
yy61:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_uint); }
yy62:
      yych = *++cur;
      if (yych == '6') goto yy78;
      goto yy11;
...
yy69:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_i16); }
yy70:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_i32); }
yy71:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_i64); }
yy72:
      yych = *++cur;
      if (yych == '_') goto yy85;
      goto yy11;
...
yy74:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_schar); }
yy75:
      yych = *++cur;
...
yy77:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_uchar); }
yy78:
      yych = *++cur;
...
yy81:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_u8); }
yy82:
      yych = *++cur;
      if (yych == 'X') goto yy92;
      if (yych == 'x') goto yy92;
...
yy83:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_ulong); }
yy84:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_double); }
yy85:
      yych = *++cur;
      if (yych == 'T') goto yy93;
      if (yych == 't') goto yy93;
...
yy87:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_single); }
yy88:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_size); }
yy89:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_u16); }
yy90:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_u32); }
yy91:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_u64); }
yy92:
      yych = *++cur;
      if (yych == '_') goto yy95;
      goto yy11;
...
yy96:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_imax); }
yy97:
      yych = *++cur;
...
yy99:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_ptrdiff); }
yy100:
      ++cur;
      cur -= 1;
      { return process_element_init(e, process_umax); }
    }
