...
jcntrl_char_array *jcntrl_csvparser_read_cell(jcntrl_csvparser *p)
{
  ...
  for (;;) {
    ...
    {
      unsigned char yych;
      if ((p->lparser.lim - p->lparser.cur) < 2) { if (!jcntrl_csvparser_fill(p, 2)) goto fillerror; }
      yych = *p->lparser.cur;
      if (yych <= '\r') {
        if (yych == '\n') goto yy5;
        if (yych >= '\r') goto yy7;
...
yy5:
      ++p->lparser.cur;
yy6:
      { jcntrl_csvparser_complete_row(p); return NULL; }
yy7:
      yych = *++p->lparser.cur;
      if (yych == '\n') goto yy5;
      goto yy6;
...
quote:
  ...
  for (;;) {
    ...
    {
      unsigned char yych;
      if ((p->lparser.lim - p->lparser.cur) < 3) { if (!jcntrl_csvparser_fill(p, 3)) goto fillerror; }
      yych = *p->lparser.cur;
      if (yych == '"') goto yy17;
      ++p->lparser.cur;
...
yy17:
      ...
      if (yych <= '\r') {
        if (yych == '\n') {
          p->lparser.ctxmrk = p->lparser.cur;
          goto yy18;
        }
        if (yych >= '\r') {
          p->lparser.ctxmrk = p->lparser.cur;
...
yy18:
      ++p->lparser.cur;
yy19:
      p->lparser.cur = p->lparser.ctxmrk;
      { return jcntrl_csvparser_make_qcell(p); }
yy20:
      yych = *++p->lparser.cur;
      if (yych == '\n') goto yy18;
      goto yy19;
